...
const JA = {
  "Music3 Semantic Studio": "Music3 セマンティックスタジオ",
  "Timeline": "タイムライン",
  "Lyrics": "歌詞",
  "Generation": "生成設定",
  "Undo": "元に戻す",
  ...
  "Open Audio Editor": "オーディオエディターを開く",
  ...
  "Mute": "ミュート",
  "Solo": "ソロ",
  "Track gain (dB)": "トラックゲイン（dB）",
  "Track pan": "トラックパン",
  "Automation": "オートメーション",
  "Edit Track Envelope on Waveform": "波形上でトラックエンベロープを編集",
  "Source take": "ソーステイク",
  "Source in (s)": "ソース開始（秒）",
  "Source out (s)": "ソース終了（秒）",
  "Timeline start (s)": "タイムライン開始（秒）",
  "Clip gain (dB)": "クリップゲイン（dB）",
  "Clip pan": "クリップパン",
  "Fade in (s)": "フェードイン（秒）",
  "Fade out (s)": "フェードアウト（秒）",
  "Fade curve": "フェードカーブ",
  "Clip muted": "クリップミュート",
  "Legacy clip envelope": "旧クリップエンベロープ",
  "Use Envelope Tool": "エンベロープツールを使用",
  "Clear Envelope": "エンベロープをクリア",
  "Gain dB": "ゲイン dB",
  "Master gain (dB)": "マスターゲイン（dB）",
  "Channel mode": "チャンネルモード",
  "Peak normalize": "ピークノーマライズ",
  "Target peak dBFS": "目標ピーク dBFS",
  "Effects": "エフェクト",
  "Preserve source": "ソースを維持",
  "Left only": "左のみ",
  "Right only": "右のみ",
  "Swap L/R": "L/Rを入れ替え",
